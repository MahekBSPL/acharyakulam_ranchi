                                    ...
                                    <tbody id="events">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <img src="{{ URL::asset('public/admin/upload/event/'.$event->image)}}" style="width:50px;height:50px;border-radius:50%;border:1px solid#ddd;">
                                                @else
                                                _____
                                                @endif
                                            </td>
                                            <td><a href="{{ URL::asset('/public/admin/upload/event/'.$event->image)}}" target="_blank"><i class="fas fa-eye"></i></a></td>
                                            <td>
