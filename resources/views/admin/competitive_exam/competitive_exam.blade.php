                                ...
                                <table id="examtable" name="examtable" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody id="exams">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if(!empty($exam->image))
                                                <a href="{{ URL::asset('admin/upload/competitiveExam/'.$exam->image) }}" target="_blank">
                                                    <img src="{{ URL::asset('/admin/upload/competitiveExam/'.$exam->image)}}" style="width:50px;height:50px;border-radius:50%;border:1px solid#ddd;">
                                                </a>
                                                @else
                                                  -
                                                @endif
                                            ...
                                            <td>
                                                @if(!empty($exam->pdf))
                                                <a href="{{ URL::asset('/admin/upload/competitiveExam/pdf/'.$exam->pdf)}}" target="_blank"><i class="fas fa-eye"></i></a>
                                                @else
                                                  -
                                                @endif
                                            </td>
