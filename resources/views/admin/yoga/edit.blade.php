                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6 col-lg-6">
                            <div class="form-group">
                                ...
                                @if($yogas->image)
                                <a href="{{ URL::asset('/admin/upload/yoga/'.$yogas->image)}}"><img src="{{ URL::asset('admin/upload/yoga/'.$yogas->image)}}" style="width:50px;height:50px;border-radius:50%;border:1px solid#ddd;"></a>
                                @endif
