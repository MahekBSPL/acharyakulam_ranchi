    ...
    <div class="col-12 col-md-12 col-lg-12">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('academic.update', $academics->id) }}" name="EditAcademic" id="EditAcademic" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6 col-lg-6">
                            <div class="form-group">
                                <input name="title" autocomplete="off" type="text" class="input_class form-control" id="title" value="{{ !empty($academics->title)?$academics->title:old('title')}}" />
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6 col-lg-6">
                            <div class="form-group">
                                <input name="year" autocomplete="off" type="text" class="input_class form-control" id="year" value="{{ !empty($academics->year)?$academics->year:old('year')}}" />
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-xm-12">
                            <div class="pull-right">
                                ...
                                <a href="{{URL::to('/admin/academic')}}" class="btn btn-primary">back</a>
                            </div>
                        </div>
                    </div>
                </form>
