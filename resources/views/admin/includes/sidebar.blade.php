<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="">
                <a href="{{ url('/admin/procedure')}}" class="nav-link"><i class="bi bi-journal-text" aria-hidden="true"></i><span>Admission Procedure</span></a>
            </li>
            <li class="">
                <a href="{{ url('/admin/procedurefee')}}" class="nav-link"><i class="bi bi-images" aria-hidden="true"></i><span>Procedure Fee</span></a>
            </li>
            <li class="">
                <a href="{{ url('/admin/proceduredescription')}}" class="nav-link"><i class="bi bi-list-task" aria-hidden="true"></i><span>Procedure Description</span></a>
            </li>
            ...
            <li class="">
                <a href="{{ url('/admin/winner')}}" class="nav-link"><i class="bi bi-award-fill" aria-hidden="true"></i><span>Winner</span></a>
            </li>
            <li class="">
