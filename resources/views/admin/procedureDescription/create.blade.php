...
@section('content')
@section('title', 'Add Procedure Description')
    ...
    <div class="col-12 col-md-12 col-lg-12">
        <div class="card">
            <div class="card-body">
                ...
                <form name="form1" action="{{URL::to('/admin/proceduredescription')}}" id="form1" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                    @csrf
