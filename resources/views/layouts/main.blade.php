      ...
      @foreach($menuparents as $menuparent)
                    <li class="dropdown">
                        <a href="#">
                            ...
                            @if($menuparent->menu_category == 1)
                                <i class="bi bi-chevron-down"></i>
                            @endif
                        </a>
                        @if($menuparent->menu_category == 2)
                            <ul>
                                @foreach($menuchilds as $menuchild)
                                    @if($menuchild->parent_id == $menuparent->id)
                                        <li><a href="{{ $menuchild->url }}">{{ $menuchild->label }}</a></li>
                                    @endif
                                @endforeach
                            </ul>
                        @endif
                ...
                @endforeach
        <!-- @foreach (menuchilds as menuchild)
      <li class="dropdown"><a href="{{menu}}"><span>{{title}}</span> <i class="bi bi-chevron-down"></i></a>
          <ul>
     
            <li><a href="{{url('frontend/introduction}}">{{title}}</a></li>
          </ul>
        </li>
@endforeach -->
        ...
        <li><a class="nav-link" href="circular.php">Circular</a></li>
      </ul>
            ...
            <div class="col-lg-4">
                ...
                <div class="credits">
                    <div class="footer-down">Follow Us
                        ...
                        <a href="https://www.facebook.com/acharyakulamrnc/" class="facebook" target="_blank"><i
         ...
         <li> <i class="fa fa-envelope" aria-hidden="true"></i>
               ...
               <li>
                ...
                <i class="fa fa-phone" aria-hidden="true"></i><span><a href="tel:+91-6287842467">+91-6287842467,
                    ...
                    <a href="tel:+91-6287842461">+91-6287842461</a></li>
                     </ul>
