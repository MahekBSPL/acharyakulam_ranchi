      ...
      <div class="row justify-content-center" style="margin:40px 0px;">
        @foreach($academicData as $academic)
          <div class="col-md-6 academic text-center">
            ...
            <img src="{{url('public/admin/upload/academic/' .$academic->image)}}">
            <div class="eye">
              <a href="{{url('public/admin/upload/academic/pdf/' .$academic->pdf)}}"><img src="{{url('public/frontend/assets/img/eye.png')}}" alt=""></a>
              <a href="{{url('public/admin/upload/academic/pdf/' .$academic->pdf)}}" download="" target="blank"><img src="{{url('public/frontend/assets/img/pdf.png')}}" alt=""></a>
            </div>
            </div>
        @endforeach
      </div>
