      ...
      <div class="container" data-aos="fade-up">
        <div class="row  align-items-center justify-content-center">
          <div class="col-md-6 academic text-center">
            ...
            <img src="{{url('frontend/img/School-Planner-2023-24.webp')}}">

            <div class="eye">
              <a href="{{url('frontend/pdf/School-Planner-2023-24.pdf')}}"><img src="{{url('frontend/img/eye.png')}}" alt=""></a>

              <a href="{{url('frontend/pdf/School-Planner-2023-24.pdf')}}" download="" target="blank"><img src="{{url('frontend/img/pdf.png')}}"
                  alt=""></a>
            </div>
      ...
      <div class="container" data-aos="fade-up">
        <div class="row mt-5">
          <div class="col-md-6 academic text-center">
            ...
            <img src="{{url('frontend/img/school-planer-2023.webp')}}">
            <div class="eye">
              <a href="{{url('frontend/pdf/School calendar 2022-2023.pdf')}}"><img src="{{url('frontend/img/eye.png')}}" alt=""></a>
          ...
          <div class="col-md-6 mt-2 academic text-center">
            ...
            <img src="{{url('frontend/img/holiday-list-2023.webp')}}">
            <div class="eye">
              <a href="{{url('frontend/pdf/Holiday list 2022-2023.pdf')}}"><img src="{{url('frontend/img/eye.png')}}" alt=""></a>

              <a href="{{url('frontend/pdf/Holiday list 2022-2023.pdf')}}" download="" target="blank"><img src="{{url('frontend/img/pdf.png')}}"
                  alt=""></a>
            </div>
          </div>
        </div>
