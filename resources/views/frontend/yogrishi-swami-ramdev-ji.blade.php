        ...
        <div class="approach">
          <div class="row align-items-center">
            <div class="col-lg-5" data-aos="zoom-out" data-aos-delay="200">
              <img src="{{url('public/frontend/assets/img/swamiji.png')}}" class="img-fluid" alt="">
            </div>
            <div class="col-lg-7  d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="200">
              <div class="content">
                <h2>Yogrishi Swami Ramdev Ji</h2>
                <ul>
                  <li>
                    <b>Yogrishi Swami Ramdev Ji</b> was born to Smt. Gulab Devi and Shri Ram Niwas in a village of
                    Haryana. He
                    had his early education in a school in his village. At the age of 14, he was admitted to the Gurukul
                    at Kalwa (near Jind, Haryana). There under the blessed tutelage of Acharya Shri Baldevji, he studied
                    Sanskrit and Yoga and earned a postgraduate (Acharya) degree with a specialization in Sanskrit
                    Vyakarana, Yoga, Darsana, Vedas and Upanisads. He thoroughly studied Satyartha Prakasa,
                    Rgvedadibhasyabhumika etc. Along-side the magnetism of Maharsi. Patanjali as an exponent of Yoga,
                    Sanskrit Grammar and Ayurveda continued to exert its influence on him. He was also inspired by the
                    life and writings of Maharshi Dayanand.
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div class="col-md-12">
            <ul>
              <li>Quite early in his life he had his goals cut out for him, so he chose the path of celibacy and
                ...
                of mundane activities.Through deep meditation and ascetic discipline and penance he was able to develop
                a clear vision of
                the work to be done by him:</li>
              <li>. Propagation of yoga and Ayurveda.</li>
              <li>. Reforming the social, political and economic system of India.</li>

              <li>Luckily he met with Acharya Balkrishna Ji, a kindred soul and a schoolmate, who was out there
              ...
              <li>In his yoga camps, attended by thousands of participants from all parts of the country, he emphasizes
                ...
                1.Bhastrika 2.Kapalabhati 3.Bahya / Agnisar 4.Ujjayi 5.Anulomaviloma 6.Bhramari 7.Udgitha 8.Pranava

                Some uksma(light) vyayamas; and some specific asanas for various ailments, as also some simple home
              ...
              <li>To give concrete shape to his dreams, Swamiji founded Divya Yog Mandir (Trust) in 1995 at Kankhal,
                Hardwar, Uttarakhand, India. It was followed by meditation Centre at Gangotri in the Himalayas;
                Brahmakalpa Chikitsalaya; Divya Pharmacy; Divya Prakashan; Divya Yog Sadhana; Patanjali Yogpeeth (Trust)
                in Delhi in 2005; Patanjali Yogpeeth, Hardwar; Mahashaya Hiralal Arsh Gurukul, Kishangarh Ghaseda,
                Mahendragarh, Haryana; Yog Gram and recently Bharat Swabhiman (Trust) in Delhi.</li>
              <li>While yoga will take care of physical, mental and spiritual health, the downslide, in social,
                ...
                products.</li>
              <li>While his mind may be soaring in the ethereal spheres of spiritualism, but his feet are firmly
              ...
              <li>For his epoch-making work, various honours/ honorary doctorates by universities have been conferred on
                him in India and abroad. On the invitation of Secretary-General of U.N.O., Swamiji has led the stand-up
                programme to pass a resolution against poverty eradication from the whole world, at United Nation
                Organisation’s head-quarter in New York, on 15 October 2006.</li>
            </ul>
          </div>
