        ...
        <div class="row rules mt-4">
          ...
          <div class="col-md-4">
            <div class="rules-inr-outer">
              ...
              <p>Students shall not keep mobile phone or any other electronic gadget or any cash in their possession in the school. If found, the same will be confiscated and will not be given back either to the student or parents or any guardian. Disciplinary action will also be taken against the child. Parents are advised not to give any costly jewellery to their ward. School management will not be responsible for any loss thereof.
              </p>
            </div>
          </div>
        </div>
        <div class="row  rules">
          ...
          <div class="col-md-4">
            ...
            <div class="rules-inr-outer">
              ...
              <p>The school will take all possible care for physical fitness of the students. However, the school does not accept any responsibility, legal or otherwise, for accidents or mishaps. The school will remain indemnified against any claim on this ground.</p>
            </div>
          </div>
          <div class="col-md-4">
            <div class="rules-inr-outer">
              ...
              <p>Any sort of discrepancy, false statement or misrepresentation of facts by parents at the time of admission, when discovered, would result in dismissal of the student from the school.
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="row rules">
          ...
          <div class="col-md-4">
            ...
            <div class="rules-inr-outer">
              ...
              <p class="px-2">From time to time important information will be sent via SMS to the parents/guardians. Hence they are requested to check them regularly.</p>
            </div>
          </div>
          <div class="col-md-4">
            <div class="rules-inr-outer">
              ...
              <p class="px-2">Parents are expected to attend all Parents -Teacher Meetings. (Both parents should come).
              </p>
            </div>
          </div>
        ...
        <div class="row  rules">
          ...
          <div class="col-md-4">
            <div class="rules-inr-outer">
              ...
              <p class="px-2">For Transfer Certificate, one week notice in writing should be given to the office.
              </p>
            </div>
          </div>
             <div class="col-md-4">
            <div class="rules-inr-outer">
              ...
              <p class="px-2">Parents are requested not to enter any classroom without prior permission of the office.</p>
            </div>
          </div>
          <div class="col-md-4">
            <div class="rules-inr-outer">
