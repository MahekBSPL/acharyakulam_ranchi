...
// Route::get('/frontend/gallery', [GalleryController::class, 'gallery']);
// Route::get('/frontend/image-gallery-2022-2023', [GalleryController::class, 'image_gallery_2022_2023']);
// Route::get('/frontend/image-gallery-2023-2024', [GalleryController::class, 'image_gallery_2023_2024']);
// Route::get('/frontend/media', [GalleryController::class, 'media']);
// Route::get('/frontend/facility', [GalleryController::class, 'facility']);
